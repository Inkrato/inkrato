...
if (config.secrets.facebook.enabled != false) {
...
// Sign in with GitHub.
if (config.secrets.github.enabled != false) {
...
if (config.secrets.twitter.enabled != false) {
...
// Sign in with Google.
if (config.secrets.google.enabled != false) {
