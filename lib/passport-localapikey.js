/**
 * Fork of API Key authentication code by Sudhakar Mani (@sudhakarmani)
 ...
 *
 * Options:
 *   - `apiKeyField`  field name where the apikey is found, defaults to 'apikey'
 *   - `apiKeyHeader`  header name where the apikey is found, defaults to 'x-apikey'
...
function Strategy(options, verify) {
  ...
  this._apiKeyHeader = options.apiKeyHeader || 'x-apikey';
